...
encodedCube = 'wrorbborowoborywoyybbggoggyryryobwbyyyorygggbgwgwwwbwr'
...
if (rotatedCubeList[46] == rotatedCubeList[49] and
    ...
    #Rotate unaligned bottom cross into top daisy
        ...
        #print('daisy created')
        storageVar = _daisySolution(encodedCube)
        #print('outside work zone')
        
        encodedCube = storageVar.get('cube')
        
        result['cube'] = "".join(encodedCube)
        result['solution'] += storageVar.get('solution')
        result['status'] = 'ok'
        print(result) 
