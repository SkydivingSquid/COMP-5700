...
class RotateTest(unittest.TestCase):
    ...
    def test_rotationController_010_ShouldRotate_F_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
        ...
        actualResult = rotate._rotationController(inputDict)
        self.assertEqual(expectedResult.get('cube'), actualResult.get('cube'))
        self.assertEqual(expectedResult.get('status'), actualResult.get('status'))
    
    def test_rotationController_020_ShouldRotate_f_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_030_ShouldRotate_R_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_040_ShouldRotate_r_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_050_ShouldRotate_B_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_060_ShouldRotate_b_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_070_ShouldRotate_L_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_080_ShouldRotate_l_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_090_ShouldRotate_U_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_100_ShouldRotate_u_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_110_ShouldRotate_d_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_120_ShouldRotate_D_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_130_ShouldRotate_F_WithMissingDir_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
        inputDict['cube'] = 'rgborogwrwbgbbrgrgoywbowrwrygwbygbyboryyggyrooybowwwoy'
        inputDict['dir'] = None
    ...
    def test_rotationController_140_ShouldRotate_F_WithEmptyDir_OnValidNominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
        inputDict['cube'] = 'rgborogwrwbgbbrgrgoywbowrwrygwbygbyboryyggyrooybowwwoy'
        inputDict['dir'] = ""
    ...
    def test_rotationController_150_ShouldRotate_F_MissingDir_OnValidNominalCube(self):
    ...
    def test_rotationController_160_ShouldRotate_MultiCharDir_OnValidnominalCube(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_610_rotate_ValidCubeLength(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_620_rotate_ValidCubeChars(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_630_rotate_ValidCubeCenterChars(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
    ...
    def test_rotationController_640_rotate_ValidDirChars(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
        inputDict['cube'] = 'rgborogwrwbgbbrgrgoywbowrwrygwbygbyboryyggyrooybowwwoy'
        inputDict['dir'] = 'a'
    ...
    def test_rotationController_650_rotate_CubeIsMissing(self):
        inputDict = {}
        inputDict['op'] = 'rotate'
        inputDict['dir'] = 'F'
