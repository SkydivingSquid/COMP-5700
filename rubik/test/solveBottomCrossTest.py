...
class solveBottomCrossTest(unittest.TestCase):
    ...
    def test_solve_031_ShouldAlignDaisyAndSolveForBottomCross_OnInputCubeWithDaisy(self):
        ...
        expectedResult = {}       
        expectedResult['cube'] = 'rywboyorrgbyoyrboboggbgrgyywygoroogrrrwgbgbbywwowwwbwy'
    ...
    #
    #     expectedResult = {}       
    #     expectedResult['cube'] = 'growbooyrwoygrbwyrorrogrbyowgrbobgrggybwywywbwobgwbygy'
    #     expectedResult['solution'] = 'FURRfrFDRR'
    #     expectedResult['status'] = 'ok'
    #
    #     actualResult = solve._solve(inputDict)
    #     self.assertEqual(expectedResult.get('cube'), actualResult.get('cube'))
    ...
    #
    #     expectedResult = {}       
    #     expectedResult['cube'] = 'obrrooggobwryybboogworgbybgbwwyrwwgbrywgborogyyyrwrygw'
    #     expectedResult['solution'] = ''
    #     expectedResult['status'] = 'ok'
    #
    #     actualResult = solve._solve(inputDict)
