...
class solveBottomFaceTest(unittest.TestCase):
...
#ITERATION 3    
    ...
    #
    # FOLLOWING TESTS ONLY WORK IF YOU COMMENT OUT LINE 118 TO RESULTS
    # THIS WAS A MISTAKE EARLY ON BASED ON A MISUNDERSTANDIN OF TDD.
    #
